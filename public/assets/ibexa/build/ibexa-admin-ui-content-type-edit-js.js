...
(function (global, doc, ibexa, React, ReactDOM) {
  var SELECTOR_RESET_STARTING_LOCATION_BTN = '.ibexa-btn--reset-starting-location';
  var resetStartingLocationBtns = doc.querySelectorAll(SELECTOR_RESET_STARTING_LOCATION_BTN);
  var udwBtns = doc.querySelectorAll('.ibexa-btn--udw-relation-default-location');
  ...
  var attachEvents = function attachEvents(btns) {
  ...
  doc.body.addEventListener('ibexa-drop-field-definition', function (event) {
    ...
    nodes.forEach(function (node) {
      var addLocationBtns = node.querySelectorAll('.ibexa-btn--udw-relation-default-location');
      var removeLocationBtns = node.querySelectorAll(SELECTOR_RESET_STARTING_LOCATION_BTN);
      attachEvents(addLocationBtns);
      removeLocationBtns.forEach(function (btn) {
